...
title: HTML
tags:
  [Languages, HTML, Semantic HTML, Guides, Cheatsheets, Templating Languages]
image: /recommends-html-cover.png
chapter: 2
icon: 🐡
---
...
- [CanIUse](https://caniuse.com/) - Search for a HTML/Css Propertie and see if you can use it in the different browsers.
- [CanIEmail](https://www.caniemail.com/) - The same as canIuse just for email.
